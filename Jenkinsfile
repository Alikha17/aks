            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'github-pat',
                    ...
                    sh '''
                        ...
                        # 2. Embed credentials into remote URL
                        git remote set-url origin https://${GIT_USER}:${GIT_TOKEN}@github.com/Alikha17/aks.git
                        ...
                        # 6. Pull latest to avoid conflicts
                        git pull --rebase origin main

                        # 7. Push with authentication
